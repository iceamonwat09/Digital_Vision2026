...
CONFIG_VERSION = "2026.08.24-livesmooth"
...
# เพดานจอ STREAM_FPS=15 อยู่แล้ว แต่กล้องอุตสาหกรรมส่งเฟรมใหญ่กว่า 4 เท่า
# ⇒ ตรวจช้าลงจนต่ำกว่า 15 ⇒ **จอกระตุกตามอัตราการตรวจ**
#
# True = ใช้เฟรมดิบล่าสุดเป็นภาพ แล้ววาดกรอบล่าสุดทับ (ภาพลื่น กรอบตามช้าเล็กน้อย
#        ตอนวัตถุขยับ — พฤติกรรมเดียวกับ LIVE_SMOOTH_VIDEO=True และกับ overlay
#        ของโหมด STREAM ที่ใช้อยู่แล้ว)
