...
# gain 12 dB = ขยายสัญญาณ 4 เท่า (dB → เท่า = 10^(dB/20)) ⇒ จากที่วัดได้ 20/255
# ที่ 5000 µs gain 0 จะได้ราว 80/255 ซึ่งเป็นระดับที่ใช้งานได้
# ⚠️ เกนไม่ได้เพิ่ม "แสง" — มันขยายทั้งสัญญาณและ noise ⇒ รอยบุบตื้นอาจถูกกลืน
#    ถ้ากระป๋องวางนิ่งให้เพิ่มเวลารับแสงแทน · ถ้าอยู่บนไลน์ต้องเพิ่มไฟจริง (แผน §6)
HIK_DEFAULTS = {
    "exposure_auto": "Off",
    "exposure_us": 5000.0,
    "gain_auto": "Off",
