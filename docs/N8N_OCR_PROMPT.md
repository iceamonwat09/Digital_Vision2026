...
> 💡 **โควตา:** ตั้งแต่มีด่านคุณภาพของ text layer (`ARTWORK_PDFTEXT_BAD_GLYPH_CHECK`)
> โซนที่ฟอนต์ในไฟล์แมปอักขระผิดจะ **ถูกส่งมาที่ N8N แทนที่จะใช้ข้อความใน PDF** ⇒
> ไฟล์ที่ฟอนต์พังจะยิง OCR มากกว่าเดิม (วัดจากไฟล์จริง 1 ฉบับ: 16 โซนจาก 54).
