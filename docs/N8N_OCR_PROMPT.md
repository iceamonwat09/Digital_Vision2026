...
> 📊 ข้อมูลที่มีก่อนทำ A/B (25 ก.ย.): รอบ 1 prompt เดิม vs รอบ 2 prompt ใหม่ —
> โซน 1-3 ขอบเขตข้อความตรงกัน (น่าจะกรอบเดียวกัน) แต่โซน 4/5 เส้นแบ่งต่างกัน
> ⇒ ยังไม่ใช่ A/B ที่สะอาด · คำที่ถูกแปล 4 → 1 · อ่านผิดใหม่ `리커블`→`리커버` 1 คำ
