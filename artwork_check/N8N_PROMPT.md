...
- **`bbox` ต่อ block เป็นทางเลือก แต่ถ้ามีจะได้กรอบแดงที่แม่นขึ้น**: ระบบใช้
  `blocks[].bbox` เป็น **ชั้นแรก** ของการหาตำแหน่ง "คำที่มีปัญหา" เพื่อวาดกรอบแดง
  บนภาพ crop ในการ์ดผลตรวจ (ถ้าไม่มี จะตกไปใช้พิกัดจาก PDF text layer หรือ
  Tesseract แทน — ผลตรวจ PASS/FAIL ไม่เปลี่ยนไม่ว่ากรณีใด)
