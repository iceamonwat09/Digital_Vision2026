...
| ③ **หลักฐานระดับฟอนต์** | ข้อความของ **ฟอนต์ที่พิสูจน์แล้วว่าพังที่อื่นในไฟล์เดียวกัน** | ทำงานเฉพาะเมื่อด่าน ① เจอหลักฐานในฟอนต์นั้นมาก่อน |
...
(**1105 ผ่าน / 5 fail เดิม** — ดูหมายเหตุท้ายตาราง):
...
| `test_artwork_fonttrust.py` | หลักฐานระดับฟอนต์: จับขยะที่ไม่มีอักขระต้องห้าม, ไฟล์ปกติต้องไม่ถูกแตะ, ฐานเทียบต้องมาจากฟอนต์อื่น, 4 โหมดความเข้ม |
