...
**ยังไม่มีค่าตั้งที่ใช้ได้ ⇒ Phase 2 (UI) ยังเริ่มไม่ได้** — ต้องหาวิธีจัดการ
noise เศษพิกเซลก่อน. `pixdiff_noise_scan.py` มีชั้น **"เทียบแนวทาง"** (blur
เบา ๆ ก่อนเทียบ · เพิ่มเกณฑ์ความต่างสี · align ระดับเศษพิกเซล) รอวัดบนไฟล์จริง.
