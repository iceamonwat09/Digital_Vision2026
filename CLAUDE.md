...
**`2026.08.25-accelwhy`** · pytest **800 ผ่าน / 5 fail เดิม** (Label Paper `FieldResult`)
...
> ```
> py -3.9 app.py            # อ่าน log ตอน start ว่าใช้ backend ไหน
> dir weights\can_dent      # bestX_openvino_model/ ใหม่กว่า bestX.pt ไหม
> py -3.9 verify_openvino.py --weights weights\can_dent\bestX.pt --images sample_cans
> ```
...
- CONFIG_VERSION ปัจจุบัน: **`2026.08.25-accelwhy`** (เช็คที่ footer ว่ารันโค้ดใหม่จริง).
