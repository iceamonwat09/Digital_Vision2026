...
|---|---|---|
| 1 | **`diagnose_hikrobot.py`** + `tests/fake_mvs/` + `tests/test_hikrobot_diagnose.py` (10 ตัว) | ✅ **เสร็จ — รอผลรันจากสถานี** |
| 2-6 | `hik_camera.py` → `config.py` → `app.py` → แท็บใน `index.html` → เทสต์+เอกสาร | ⏳ รอตัวเลขจากขั้น 1 |
